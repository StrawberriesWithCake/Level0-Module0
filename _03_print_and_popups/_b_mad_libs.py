...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title='Piranhas', message="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adjective = simpledialog.askstring(title=' ', prompt="enter an adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='Piranhas', prompt="enter a type of liquid")
    # Get the player to enter a body part
    body_part = simpledialog.askstring(title='Piranhas', prompt="enter a type of body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='Piranhas', prompt="enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title='Piranhas', prompt="enter a type of place")
    ...
    messagebox.showinfo(title='Piranhas', message= story)
